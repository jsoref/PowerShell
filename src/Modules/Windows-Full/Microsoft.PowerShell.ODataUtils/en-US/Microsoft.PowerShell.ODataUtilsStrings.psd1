...
VerboseSavedTypeDefinitionModule=Saved Type definition module '{0}' at '{1}'.
VerboseAddingTypeDefinitionToGeneratedModule=Adding Type definition for '{0}' to '{1}' module.
