//-----------------------------------------------------------------------
// <copyright file="ParameterSetViewModel.cs" company="Microsoft">
    ...
    public class ParameterSetViewModel : INotifyPropertyChanged
    {
        ...
        private static char ParameterNeedsDelimitation(string parameterValue, bool requireScriptblock)
        {
            ...
            if (stringValue != null)
            {
                ...
                {
                    Diagnostics.Assert(stringValue.StringConstantType == StringConstantType.SingleQuoted || stringValue.StringConstantType == StringConstantType.SingleQuotedHereString, "those are the 2 enumeration values left");
                    stringTerminationChar = '\'';
                }
