    ...
    public class PackageSourceListProvider {
        ...
        private bool ValidatePackageManagementVersion(PackageSourceListRequest request)
        {
            ...
            if (!_doesPackageManagementVersionMatch)
            {
                ...
                {
                    request.WriteError(ErrorCategory.InvalidOperation, Constants.ProviderName, Resources.Messages.MinimumVersonCheck, Constants.ProviderName, RequiredPackageManagementVersion, _currentPackageManagementVersion);
                }
                else
                {
                    request.Verbose(Resources.Messages.MinimumVersonCheck, Constants.ProviderName, RequiredPackageManagementVersion, _currentPackageManagementVersion);
                }
            }
